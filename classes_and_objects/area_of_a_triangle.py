...
class Triangle(Polygon):
    ...
    def __init__(self):
        Polygon.__init__(self, 3)  # taking inputs using parent class
    ...
    def findArea(self):
        ...
        print('The area of the triangle is %0.2f' % area)  # float with 2 decimal points


# MAIN - Creating an instance/objects of the Triangle class
t = Triangle()
